        ...
        return <React.Fragment>
            <div className="shadow m-2 col-lg-3 col-10 offset-lg-0 offset-1  pre-scrollable">
                <div className="h5 p-4 text-center text-dark">
                    ...
                    <label className=" row input-plan d-flex jumbotron p-3 border border-primary" id="plan101">
                ...
                <div className="col-12 p-4">
                    ...
                    <label className=" row input-plan d-flex jumbotron p-3 border border-primary" id="plan102">
                        <div className="col-12 d-flex justify-content-between">
                ...
                <div className="col-12 p-4">
                    ...
                    <label className=" row input-plan d-flex jumbotron p-3 border border-primary" id="plan103">
                        <div className="col-12 d-flex justify-content-between">
                ...
                <div className="col-12 p-4">
                    ...
                    <label className=" row input-plan d-flex jumbotron p-3 border border-primary" id="plan104">
                        <div className="col-12 d-flex justify-content-between">
            ...
            {this.state.plan !== "" ? (<React.Fragment>
                <div className="shadow m-2 col-lg-5 col-10 offset-lg-0 offset-1">
                    <PlanDetails plan={this.state.plan} planSelected={this.state.planSelected} />
                </div>
                <div className="container h5 border text-left" >
...
class PlanDetails extends Component {
    ...
    render() {
        return <div className="text-left container h-100 d-flex flex-column">
